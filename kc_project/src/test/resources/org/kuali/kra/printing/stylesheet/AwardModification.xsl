						...
						<xsl:for-each select="$XML">
							<xsl:if test="count(  AwardNotice/AwardDisclosure/DisclosureItem  ) &gt; 0">
								<xsl:for-each select="AwardNotice">
									<xsl:for-each select="SchoolInfo">
										...
										<fo:block font-family="Times New Roman" font-size="9pt" line-height="9pt" text-align="center" margin="0pt">
											<fo:block>
												<fo:inline-container>
													<fo:block>
														<xsl:text>&#x2029;</xsl:text>
																...
																<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																	...
																	<fo:table-body start-indent="0pt">
																		<xsl:for-each select="DisclosureItem">
																			<fo:table-row>
																				<fo:table-cell padding-left="20pt" padding="2pt" height="8" display-align="center">
																					<fo:block>
																				...
																				<fo:table-cell padding="2pt" height="8" display-align="center">
																					<fo:block>
												...
												<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
													...
													<fo:table-body start-indent="0pt">
														<fo:table-row>
															...
															<fo:table-cell padding-left="0" padding="2pt" display-align="before">
																<fo:block>
																	<xsl:for-each select="AwardNotice">
																		<xsl:for-each select="Award">
																			<xsl:for-each select="AwardDetails">
														...
														<fo:table-row>
															<fo:table-cell padding="0" number-columns-spanned="6" display-align="center">
																<fo:block>
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="AwardNotice">
																			<xsl:for-each select="Award">
																						...
																						<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																							...
																							<fo:table-body start-indent="0pt">
																								<xsl:for-each select="Investigator">
																									<fo:table-row>
																										<fo:table-cell padding-left="10pt" padding="2pt" display-align="before">
																											<fo:block>
																												<xsl:for-each select="PersonName">
																													<xsl:variable name="value-of-template">
																														<xsl:apply-templates/>
																													...
																													<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																														...
																														<fo:table-body start-indent="0pt">
																															<xsl:for-each select="InvestigatorUnit">
																																<fo:table-row>
																																	<fo:table-cell padding="0" height="16" display-align="before">
																																		<fo:block>
										...
										<fo:table-cell padding="0" display-align="center">
											<fo:block>
												...
												<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
													...
													<fo:table-body start-indent="0pt">
														<fo:table-row>
															<fo:table-cell padding="6pt" padding-top="15pt" border="solid 1pt gray" height="12" text-align="center" display-align="center">
																<fo:block>
																	<fo:inline font-family="Times New Roman" font-size="9pt" font-weight="bold">
											...
											<fo:block>
												...
												<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
													...
													<fo:table-body start-indent="0pt">
														<fo:table-row>
															<fo:table-cell number-columns-spanned="4" padding="2pt" display-align="center">
																<fo:block>
																	...
																	<fo:table border-collapse="0" font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
																		<fo:table-column column-width="595"/>
																		<fo:table-column column-width="proportional-column-width(1)"/>
																		<fo:table-column column-width="proportional-column-width(1)"/>
																		<fo:table-column column-width="proportional-column-width(1)"/>
																		<fo:table-body font-family="Arial" start-indent="0pt">
																			<fo:table-row font-family="Arial">
																				<fo:table-cell font-family="Arial" padding-bottom="0" padding-top="10pt" padding="0" height="25" display-align="center">
																					<fo:block>
																						<fo:inline font-weight="bold">
																				...
																				<fo:table-cell font-family="Arial" font-size="9pt" number-columns-spanned="3" padding="0" display-align="center">
																					<fo:block/>
																				</fo:table-cell>
																			</fo:table-row>
																		</fo:table-body>
																	...
																	<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																		<fo:table-column column-width="318"/>
																		<fo:table-column column-width="15%"/>
																		<fo:table-body start-indent="0pt">
																			<fo:table-row>
																				<fo:table-cell font-family="Arial" padding-bottom="0" padding-top="10pt" padding="2pt" display-align="before">
																					<fo:block>
																				...
																				<fo:table-cell font-family="Times New Roman" font-size="9pt" padding="2pt" display-align="after">
																					<fo:block>
																						<xsl:for-each select="AwardNotice">
																							<xsl:for-each select="Award">
																								<xsl:for-each select="AwardDetails">
																	...
																	<xsl:if test="count( AwardNotice/Award/AwardAmountInfo  )  = 1">
																		...
																		<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																			...
																			<fo:table-body start-indent="0pt">
																				<fo:table-row>
																					<fo:table-cell font-family="Arial" padding-top="10pt" padding="2pt" display-align="before">
																						<fo:block>
																							<fo:inline font-weight="bold" padding-top="10pt">
																				...
																				<fo:table-row>
																					<fo:table-cell padding-top="10pt" padding="2pt" display-align="before">
																						<fo:block>
																							<fo:inline font-weight="bold" padding-top="10pt">
																				...
																				<fo:table-row>
																					<fo:table-cell padding-top="10pt" padding="2pt" height="22" display-align="before">
																						<fo:block>
																							<fo:inline font-weight="bold" padding-top="10pt">
																					...
																					<fo:table-cell padding-top="10pt" padding="2pt" height="22" display-align="after">
																						<fo:block>
																							<xsl:for-each select="$XML">
																								<xsl:for-each select="AwardNotice">
																									<xsl:for-each select="Award">
																				...
																				<fo:table-row>
																					<fo:table-cell padding="2pt" height="20" display-align="before">
																						<fo:block>
																							<fo:inline font-weight="bold" padding-top="10pt">
																					...
																					<fo:table-cell padding="2pt" height="20" display-align="after">
																						<fo:block>
																							<xsl:for-each select="AwardNotice">
																								<xsl:for-each select="Award">
																									<xsl:for-each select="AwardAmountInfo">
																		...
																		<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																			...
																			<fo:table-body start-indent="0pt">
																				<fo:table-row>
																					<fo:table-cell font-family="Arial" padding-top="12pt" padding="2pt" display-align="before">
																						<fo:block>
																							<fo:inline font-weight="bold" padding-top="10pt">
														...
														<fo:table-row>
															<fo:table-cell padding="0" number-columns-spanned="4" display-align="center">
																<fo:block>
																	<fo:block>
																		<fo:leader leader-pattern="space"/>
																	</fo:block>
																				...
																				<fo:table font-weight="bold" table-layout="fixed" width="100%" border-spacing="2pt">
																					...
																					<fo:table-body start-indent="0pt">
																						<fo:table-row>
																							...
																							<fo:table-cell font-family="Times New Roman" font-size="9pt" padding-left="4pt" padding="2pt" display-align="center">
																								<fo:block>
																									<xsl:for-each select="AwardNotice">
																										<xsl:for-each select="Award">
																											<xsl:for-each select="AwardDetails">
							...
							<xsl:for-each select="AwardNotice">
								...
								<xsl:for-each select="Award">
									...
									<fo:block font-family="Times New Roman" font-size="9pt" line-height="9pt" margin="0pt">
										<fo:block>
											<fo:block>
												<fo:leader leader-pattern="space"/>
											</fo:block>
														...
														<xsl:for-each select="AwardScienceCodes">
															...
															<xsl:if test="ScienceCodeDetail">
																<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																	...
																	<fo:table-header start-indent="0pt">
																		<fo:table-row>
																			<fo:table-cell padding="2pt" height="17" display-align="center">
																				<fo:block>
																					<fo:inline font-size="9pt">
																			...
																			<fo:table-cell padding="2pt" height="17" text-align="left" display-align="center">
																				<fo:block>
																					<fo:inline font-size="9pt">
																								...
																								<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																									...
																									<fo:table-body start-indent="0pt">
																										<xsl:for-each select="TermDetails">
																											<fo:table-row>
																												<fo:table-cell padding-bottom="0" padding-top="0" padding="2pt" text-align="left" display-align="center">
																													<fo:block>
																														<fo:inline font-size="9pt">
																															<xsl:text>- </xsl:text>
																														</fo:inline>
																												...
																												<fo:table-cell padding-bottom="0" padding-left="0" padding-top="0" padding="2pt" text-align="left" display-align="center">
																													<fo:block>
																			...
																			<xsl:for-each select="Comment">
																				<fo:table-row>
																					...
																					<fo:table-cell padding-bottom="5pt" padding-top="0" padding="2pt" display-align="before">
																						<fo:block>
																							<xsl:if test="CommentDetails/CommentCode  &gt; 1 and CommentDetails/CommentCode  &lt; 7  and  string-length(CommentDetails/Comments ) &gt;= 1">
																								<xsl:for-each select="Description">
																									<xsl:variable name="value-of-template">
																										<xsl:apply-templates/>
																									</xsl:variable>
																									...
																									<xsl:for-each select="Comments">
																										...
																										<fo:block white-space="pre" white-space-collapse="false" margin="0pt">
																											<fo:block>
																												...
																												<xsl:choose>
																													<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																														<fo:block font-size="9pt" line-height="9pt">
																															<xsl:copy-of select="$value-of-template"/>
																														</fo:block>
																													</xsl:when>
																													<xsl:otherwise>
																														<fo:inline font-size="9pt" line-height="9pt">
																															<xsl:copy-of select="$value-of-template"/>
																														</fo:inline>
																													</xsl:otherwise>
																												</xsl:choose>
																								...
																								<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																									...
																									<fo:table-body start-indent="0pt">
																										...
																										<fo:table-row>
																											...
																											<fo:table-cell font-size="9pt" padding="0" padding-bottom="0" padding-top="0" display-align="center">
																												<fo:block>
																													<xsl:if test="DueDate != &apos;1900-01-01+00:00&apos;">
																														<xsl:for-each select="DueDate">
																															<fo:inline>
																			...
																			<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																				...
																				<fo:table-header start-indent="0pt">
																					<fo:table-row>
																						...
																						<fo:table-cell padding-left="80pt" padding="2pt" display-align="center">
																							<fo:block>
																								<fo:inline font-weight="bold">
																									<xsl:text>Due Date</xsl:text>
																								</fo:inline>
																				...
																				<fo:table-body start-indent="0pt">
																					<xsl:for-each select="PaymentSchedule">
																						<fo:table-row>
																							...
																							<fo:table-cell font-size="9pt" padding-left="80pt" padding="2pt" display-align="center">
																								<fo:block>
																									<xsl:for-each select="DueDate">
																										<fo:inline>
																											<xsl:value-of select="format-number(number(substring(string(string(.)), 6, 2)), '00')"/>
										...
										<xsl:for-each select="AwardNotice">
											<xsl:for-each select="SchoolInfo">
												<xsl:for-each select="Acronym">
													...
													<xsl:choose>
														<xsl:when test="contains(string($value-of-template),'&#x2029;')">
															<fo:block font-family="Verdana" font-size="9pt" font-weight="bold">
																<xsl:copy-of select="$value-of-template"/>
															</fo:block>
														</xsl:when>
														<xsl:otherwise>
